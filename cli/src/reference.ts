...
export const COMMANDS: Command[] = [
  {
    ...
    description: [
      "Reads the registry as it is on disk; no network. One line per mod, owner/name, then each harness it supports with the release its patches are for; an asterisk marks where you have it installed. Unpublished mods from ~/.open-mods/local are listed too, marked (local).",
    ],
    flags: [
    ...
    examples: [{ command: "open-mods list" }, { command: "open-mods list --codex", note: "only mods for Codex" }],
    audience: "users",
  },
  {
    name: "info",
    ...
    examples: [{ command: "open-mods info shouryamaanjain/tetris" }, { command: "open-mods info shouryamaanjain/tetris --codex" }],
    audience: "users",
  },
  {
    name: "install",
    aliases: ["add"],
    usage: "open-mods install <owner>/<mod> [<owner>/<mod> ...] [--<harness> ...]",
    short: "open-mods install <owner>/<mod> [--<harness>]",
    ...
    examples: [
      { command: "open-mods install shouryamaanjain/tetris", note: "asks which harness" },
      { command: "open-mods install shouryamaanjain/tetris --opencode" },
      { command: "open-mods install shouryamaanjain/tetris shouryamaanjain/hello-placeholder --codex", note: "two mods, one build" },
    ],
    audience: "users",
  },
  {
    name: "uninstall",
    aliases: ["remove", "rm"],
    usage: "open-mods uninstall <owner>/<mod> [<owner>/<mod> ...] [--<harness> ...]",
    short: "open-mods uninstall <owner>/<mod> [--<harness>]",
    ...
    examples: [{ command: "open-mods uninstall shouryamaanjain/tetris" }, { command: "open-mods uninstall shouryamaanjain/tetris --codex" }],
    audience: "users",
  },
  {
    name: "status",
  ...
  {
    name: "on",
    usage: "open-mods on [harness | <owner>/<mod> [--<harness>]]",
    ...
    examples: [{ command: "open-mods on" }, { command: "open-mods on shouryamaanjain/tetris --opencode" }],
    audience: "users",
  },
  {
    name: "off",
    usage: "open-mods off [harness | <owner>/<mod> [--<harness>]]",
    ...
    examples: [{ command: "open-mods off" }, { command: "open-mods off codex", note: "just Codex" }, { command: "open-mods off shouryamaanjain/tetris --codex" }],
    audience: "users",
  },
  {
    name: "update",
  ...
  {
    name: "check",
    usage: "open-mods check <mod-folder | owner/mod --<harness>> [--ref <tag>] [--typecheck | --build] [--json]\nopen-mods check --harness <id> --ref <tag> [--typecheck | --build] [--json]",
    short: "open-mods check <owner>/<mod> --<harness> [--typecheck | --build]",
    ...
    examples: [
      { command: "open-mods check you/my-mod --opencode --build" },
      { command: "open-mods check mods/you/my-mod/opencode --ref v1.19.0 --typecheck" },
...
export const FILES: Flag[] = [
  ...
  { flag: "~/.open-mods/local/<owner>/<mod>", description: "Your own unpublished mods, laid out like the registry." },
